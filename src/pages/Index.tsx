      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-8 py-10 sm:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          <div className="text-center lg:text-left relative">
            ...
            <div className="absolute -bottom-5 -left-5 w-8 sm:w-12 h-8 sm:h-12 bg-teal-300 rounded-full opacity-60"></div>
            <div className="absolute top-1/2 -left-8 w-6 sm:w-8 h-6 sm:h-8 bg-teal-400 rounded-full opacity-40"></div>
